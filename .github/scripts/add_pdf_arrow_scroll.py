...
s=p.read_text(encoding='utf-8')
s=s.replace('viewer-v2.js?v=20260909zoomsteps1','viewer-v2.js?v=20260909arrowscroll1')
s=s.replace('viewer-v2.js?v=20260909keyboard1','viewer-v2.js?v=20260909arrowscroll1')
p.write_text(s,encoding='utf-8')

p=Path('service-worker.js')
s=p.read_text(encoding='utf-8')
s=s.replace('efp-pwa-2026-09-09-v93-pdf-zoom-steps','efp-pwa-2026-09-09-v94-pdf-arrow-scroll')
s=s.replace('efp-pwa-2026-09-09-v92-pdf-keyboard','efp-pwa-2026-09-09-v94-pdf-arrow-scroll')
s=s.replace('/Crux-Tricks/viewer-v2.js?v=20260909zoomsteps1','/Crux-Tricks/viewer-v2.js?v=20260909arrowscroll1')
s=s.replace('/Crux-Tricks/viewer-v2.js?v=20260909keyboard1','/Crux-Tricks/viewer-v2.js?v=20260909arrowscroll1')
p.write_text(s,encoding='utf-8')
