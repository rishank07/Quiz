...
(function () {
  ...
  function injectStyle() {
    ...
    style.textContent =
      ...
      "overscroll-behavior-y:none;" +
      "}" +
      /* A few older quiz templates set a parent colour but leave statement
         text unstyled. Give every question a dark pre-inversion fallback;
         explicitly coloured headings/options continue to keep their colours. */
      "html.efp-black-invert body .question-box{" +
      "color:#111 !important;" +
      "}" +
