...
(function () {
  ...
  function injectStyle() {
    ...
    style.textContent =
      ...
      ".efp-ca-practice-link .link-text { display:block; min-width:0; }" +
  ...
  function installCurrentAffairsPracticeLink() {
    ...
    link.innerHTML = '<span class="link-text">📝 Practice Quiz MCQ</span><span class="efp-ca-practice-arrow">→</span>';
